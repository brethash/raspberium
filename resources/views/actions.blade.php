                    ...
                    <div class="button-box col-md-4">
                        ...
                        <ul>
                            <li class="btn-group">
                                ...
                                <button class="btn btn-default" id="light1Timer" data-device="light1" data-state="timer">Timer</button>
                        ...
                        <ul>
                            <li class="btn-group">
                                ...
                                <button class="btn btn-default" id="light2Timer" data-device="light2" data-state="timer">Timer</button>
                    ...
                    <div class="button-box col-md-4">
                        ...
                        <ul>
                            <li class="btn-group">
                                ...
                                <button class="btn btn-default" id="pump1Timer" data-device="mistingSystem1" data-state="timer">Timer</button>
                    ...
                    <div class="button-box col-md-4">
                        ...
                        <ul>
                            <li class="btn-group">
                                ...
                                <button class="btn btn-default" id="fan1Timer" data-device="fan1" data-state="timer">Timer</button>
